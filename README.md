...
- **🚀 Espanso Control** — start, stop, and restart espanso from the sidebar
...
```bash
# Runs Vite + Electron together with hot reload
...
3. Use the **Snippets** view to manage all your text expansions
4. Use the **Configuration** view to change global settings and the trigger symbol
5. Use the **Packages** view to install community packages
6. Use the **Terminal** view to run espanso commands
