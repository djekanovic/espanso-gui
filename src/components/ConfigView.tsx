...
import { parseConfigSettings, buildConfigContent, detectTriggerSymbol, applyTriggerSymbolToAll, extractMatches, buildMatchFileContent } from '../utils/yaml'
        ...
        if (files.success && files.files) {
          for (const file of files.files) {
            ...
            if (fileResult.success && fileResult.content) {
              ...
              const newContent = buildMatchFileContent(updatedMatches, `# ${file.name.replace(/\.(yml|yaml)$/, '')}\n# Managed by Espanso GUI\n`)
